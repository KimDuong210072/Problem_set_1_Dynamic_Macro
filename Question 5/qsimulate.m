...
classdef qsimulate
    methods(Static)
        ...
        function sim = grow(par,sol)            
            ...
            nsim(1) = npol(k0_ind,A0_ind,h0_ind); % Labor supply in period 1 given k0 and A0.
            ksim(1) = kpol(k0_ind,A0_ind,h0_ind); % Capital choice for period 2 given k0 and A0.
            hsim(1) = hpol(k0_ind,A0_ind,h0_ind);
            isim(1) = ipol(k0_ind,A0_ind,h0_ind); % Investment in period 1 given k0 and A0.
